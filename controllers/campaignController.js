...
exports.getCampaign = async (req, res) => {
  ...
  // exports.addPipelineToCampaign = async (req, res) => {
  //   try {
  //     const { campaignid } = req.params; // Campaign ID from the URL
  //     const { pipelineid } = req.body; // Pipeline ID from the request body
  ...
  //     // Update the campaign with the new pipeline ID
  //     campaign.Pipeline = pipelineid; // Assign the pipeline ID to the campaign
  //     await campaign.save(); // Save the updated campaign document
  
  //     // Return the updated campaign
  //     res.status(200).json({
  //       message: "Pipeline added to the campaign successfully.",
  //       campaign,
  //     });
  //   } catch (error) {
  //     console.error("Error in addPipelineToCampaign:", error.message);
  //     res.status(500).json({
  ...
  //     const campaigns = await Campaign.findById({ pipelineId: pipelineId })
